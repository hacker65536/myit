...
Installed Packages
vim-common.x86_64                                2:7.4.160-4.amzn2.0.16                                installed
Available Packages
...
```console
$ yumdownloader --source vim-common-2:8.0.1257-2.amzn2.x86_64
Loaded plugins: extras_suggestions, langpacks, priorities, update-motd
...
vim-8.0.1257-2.amzn2.src.rpm                              
```


```console
$ rpm -ivh vim-8.0.1257-2.amzn2.src.rpm
```
